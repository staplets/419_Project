...
protected://protected member variables.
     std::string name;
     std::vector<std::string> exits{ std::vector<std::string>{"library", "billiards room", "hallway"} };
     std::vector<std::string> objects{ std::vector<std::string>{"computer", "mr.green"} };
     int numRooms;
     int numObjects;
